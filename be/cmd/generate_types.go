...
func generateTypes() {
	...
	converter := typescriptify.New().Add(api.GlobalData{}).Add(api.Set{}).Add(api.Card{}).Add(api.AddOwnedSetInput{}).Add(api.OwnedCardInput{}).Add(api.SetOwnedCardsInput{}).Add(api.EbayListing{}).Add(api.EbayListingsResponse{}).Add(api.CardPriceTrend{}).Add(api.AdminInviteRequest{}).Add(api.SetCardCharacterModelInput{})
